...
const mockOverdue = [
    { id: "1", title: "Finalize Copper Contract", topic: "Copper LME China", deadline: "Yesterday", assignees: ["Anar", "admin"] }
]

const mockToday = [
    { id: "2", title: "Call Logistics for pricing", topic: "Transformer Sales", deadline: "Today 16:00", assignees: ["Ram"] },
    { id: "3", title: "Review Q3 Report", topic: "Internal", deadline: "Today 18:00", assignees: ["Alik", "Magel"] }
]

const mockActive = [
    { id: "4", title: "Draft Mediation Terms", topic: "Mediation Deals", deadline: "Tomorrow", assignees: ["Smit"] }
]
        ...
        <div className="flex flex-col gap-8 p-6 md:p-10">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-500">Welcome back. Here is your team overview.</p>
                </div>
            ...
            {mockOverdue.length > 0 && (
                <section>
                    <div className="mb-4 flex items-center gap-2 text-red-600">
                        ...
                        <h2 className="text-lg font-semibold">Problem Tasks</h2>
